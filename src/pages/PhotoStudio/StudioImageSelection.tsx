...
import { FaImages, FaFolder, FaFolderOpen, FaChevronRight, FaCheck, FaCheckCircle, FaArrowRight, FaCopy, FaShare } from 'react-icons/fa';
      ...
      {selectedImages.size > 0 && (
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
          ...
          <p className="text-xs text-gray-500 mt-2">
            Share this URL with your client to view and select from these photos
          </p>
        </div>
      )}
