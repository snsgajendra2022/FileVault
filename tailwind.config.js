...
module.exports = {
  ...
  content: [
    './src/**/*.{js,jsx,ts,tsx}',
    './whatsapp-plugin/src/**/*.{js,jsx,ts,tsx}',
  ],
  theme: {
    extend: {
      fontFamily: {
      ...
      boxShadow: {
        ...
        'clients-card-hover':
          '0 28px 56px -16px rgba(79, 70, 229, 0.22), 0 12px 28px -12px rgba(15, 23, 42, 0.12)',
        'clients-shell':
          '0 32px 64px -20px rgba(15, 23, 42, 0.14), 0 0 0 1px rgba(255, 255, 255, 0.6) inset',
        'clients-cta':
          '0 8px 24px -4px rgba(79, 70, 229, 0.45), 0 0 0 1px rgba(255,255,255,0.2) inset',
        'clients-cta-hover':
          '0 14px 36px -6px rgba(109, 40, 217, 0.55), 0 0 0 1px rgba(255,255,255,0.25) inset',
      },
